...
figure <- df_renamed_eu |> 
  ...
  labs(
    title = "How have trends in deaths due to household air pollution from solid fuels evolved\nin the EU countries over the last 30 years?",
    subtitle = "Fortunately, all countries have witnessed sharp declines ranging from 62 to 95%.",
    x = NULL,
    y = "deaths\n(%)",
